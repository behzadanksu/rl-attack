...
def model(img_in, num_actions, scope, reuse=False, layer_norm=False, concat_softmax=False):
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        with tf.variable_scope("action_value"):
            ...
            if concat_softmax:
                value_out = tf.nn.softmax(value_out)
        return value_out


def dueling_model(img_in, num_actions, scope, reuse=False, layer_norm=False, concat_softmax=False):
